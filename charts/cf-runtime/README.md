...
![Version: 6.3.47](https://img.shields.io/badge/Version-6.3.47-informational?style=flat-square)
...
| runtime.engine.image | object | `{"pullPolicy":"IfNotPresent","registry":"quay.io","repository":"codefresh/engine","tag":"1.173.3"}` | Set image. |
