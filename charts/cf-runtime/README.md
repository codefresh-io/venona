...
![Version: 6.3.55](https://img.shields.io/badge/Version-6.3.55-informational?style=flat-square)
...
| runtime.engine.image | object | `{"pullPolicy":"IfNotPresent","registry":"quay.io","repository":"codefresh/engine","tag":"1.174.0"}` | Set image. |
