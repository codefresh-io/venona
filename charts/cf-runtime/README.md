...
![Version: 6.2.7](https://img.shields.io/badge/Version-6.2.7-informational?style=flat-square)
...
| runtime.engine.image | object | `{"registry":"quay.io","repository":"codefresh/engine","tag":"1.166.4"}` | Set image. |
