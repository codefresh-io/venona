...
![Version: 6.3.49](https://img.shields.io/badge/Version-6.3.49-informational?style=flat-square)
...
| runtime.engine.image | object | `{"pullPolicy":"IfNotPresent","registry":"quay.io","repository":"codefresh/engine","tag":"1.173.4"}` | Set image. |
