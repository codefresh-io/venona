...
| runtime.engine.env.PROPAGATE_ENVS_TO_INTERNAL_CONTAINERS_ENABLE | bool | `false` | If "true", propagate environmental variables from engine to container-logger listed in PROPAGATE_ENVS_TO_INTERNAL_CONTAINERS_LIST |
| runtime.engine.env.PROPAGATE_ENVS_TO_INTERNAL_CONTAINERS_LIST | string | `""` | A list of variables to propagate from engine to container-logger (comma-separated string) |
