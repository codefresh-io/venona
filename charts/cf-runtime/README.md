...
![Version: 6.3.60](https://img.shields.io/badge/Version-6.3.60-informational?style=flat-square)
...
| runtime.engine.image | object | `{"pullPolicy":"IfNotPresent","registry":"quay.io","repository":"codefresh/engine","tag":"1.174.11"}` | Set image. |
