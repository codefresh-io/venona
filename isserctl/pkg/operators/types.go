...
*/
//go:generate go run github.com/codefresh-io/Isser/isserctl/templates kubernetes
//go:generate go run github.com/codefresh-io/Isser/isserctl/obj kubernetes
package operators
