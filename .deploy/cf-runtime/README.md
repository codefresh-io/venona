...
| storage.ebs.accessKeyId | optional | `""` | Set AWS_ACCESS_KEY_ID for volume-provisioner Ref: https://codefresh.io/docs/docs/installation/codefresh-runner/#dind-volume-provisioner-permissions |
| storage.ebs.availabilityZone | required | `"us-east-1a"` | Set EBS volumes availability zone |
| storage.ebs.encrypted | optional | `"false"` | Enable encryption |
| storage.ebs.kmsKeyId | optional | `""` | Set KMS encryption key ID |
| storage.ebs.secretAccessKey | optional | `""` | Set AWS_SECRET_ACCESS_KEY for volume-provisioner Ref: https://codefresh.io/docs/docs/installation/codefresh-runner/#dind-volume-provisioner-permissions |
| storage.ebs.volumeType | required | `"gp2"` | Set EBS volume type (`gp2`/`gp3`/`io1`) |
...
| storage.gcedisk.serviceAccountJson | optional | `""` | Set Google SA JSON key for volume-provisioner |
